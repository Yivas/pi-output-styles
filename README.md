...
**Status:** release `v0.6.0`. Compatibility has been verified against Pi 0.87.0 only.
...
The npm package `pi-response-styles` is published as `0.6.0`; its first npm version was `0.2.0`. The repository and product keep the name `pi-output-styles`. The current release is `v0.6.0` on GitHub and npm.
